...
const WHATSAPP_API_URL = process.env.WHATSAPP_API_URL; // e.g., for Twilio: 'https://api.twilio.com/2010-04-01/Accounts/ACxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/Messages.json'
